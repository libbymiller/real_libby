# adapted from https://github.com/PeterKaminski09/baskup/blob/master/baskup.sh
BACKUP_DIR=./backup

OS_Version=$(sw_vers -productVersion)
LAST_VERSION=10.13
NEEDS_MODIFICATION=$(echo $OS_Version '>=' $LAST_VERSION)
BACKUP_ATTACHMENTS=1

for line in $(sqlite3 /Users/[me]/gpt-2/scripts/baskup-master/imessagedb "select distinct guid from chat;" ); do
  echo "."
  contact=$line
  arrIN=(${contact//;/ })
  ...
  if [[ $NEEDS_MODIFICATION == 1 ]]; then
    sqlite3 /Users/[me]/gpt-2/scripts/baskup-master/imessagedb "
